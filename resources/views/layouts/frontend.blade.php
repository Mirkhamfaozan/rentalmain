...
<body class="d-flex flex-column h-100">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top shadow-sm">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand fw-bold fs-4 navbar-brand-gradient text-decoration-none"
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                @auth
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <a href="{{ route('user.notifications') }}"
                            class="position-relative text-decoration-none text-dark" title="Notifications">
                            <i class="bi bi-bell fs-5"></i>
                            @if ($notificationCount > 0)
                                <span
                                    class="badge bg-danger rounded-pill notification-badge">{{ $notificationCount }}</span>
                            @endif
                        </a>
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end shadow border-0" aria-labelledby="profileDropdown">
                                <!-- Di dalam dropdown menu profil (bagian yang menangani status rental) -->
                                @if (Auth::user()->isRental())
                                    ...
                                    @elseif($rentalBiodata && $rentalBiodata->isRejected())
                                        <li>
                                            <a class="dropdown-item py-2" href="{{ route('profile.show') }}">
                                                <i class="bi bi-exclamation-triangle me-2 text-danger"></i>Perbarui Data
                                                <small class="d-block text-danger">Verifikasi ditolak - Klik untuk
                                                    perbaikan</small>
                                            </a>
                                        </li>
                                    ...
                                    @else
                                        <li>
                                            <a class="dropdown-item py-2" href="{{ route('profile.show') }}">
                                                <i class="bi bi-pencil-square me-2"></i>Lengkapi Biodata
                                                <small class="d-block text-warning">Klik untuk melengkapi data
                                                    rental</small>
                                            </a>
                                        </li>
                                    @endif
                ...
                @guest
                    <div class="d-flex gap-2">
                        ...
                        <a class="btn btn-info text-white px-4 fw-medium" href="{{ route('register') }}">
