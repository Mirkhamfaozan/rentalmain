                    ...
                    <div class="card shadow-lg border-0"
                        ...
                        <div class="card-body p-5">
                            ...
                            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="d-flex gap-4 mt-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="role" id="roleUser"
                                                value="users" {{ old('role', 'users') == 'users' ? 'checked' : '' }}>
                                            <label class="form-check-label fw-medium" for="roleUser">
                                                <i class="bi bi-person me-1"></i>Pengguna Biasa
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="role" id="roleRental"
                                                value="rental" {{ old('role') == 'rental' ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password"
                                                ...
                                                id="password" name="password" placeholder="Buat kata sandi yang kuat"
                                                required>
                                ...
                                <div id="rentalFields"
                                    style="display: {{ old('role') == 'rental' ? 'block' : 'none' }};">
                                    <div class="mb-4">
                                        <h5 class="fw-semibold text-dark mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control border-start-0 @error('alamat') is-invalid @enderror" id="alamat" name="alamat"
                                                    rows="3" placeholder="Alamat lengkap bisnis rental" {{ old('role') == 'rental' ? 'required' : '' }}>{{ old('alamat') }}</textarea>
                                            </div>
                                            @error('alamat')
                                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Kota" {{ old('role') == 'rental' ? 'required' : '' }}>
                                                @error('kota')
                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="tel"
                                                        ...
                                                        value="{{ old('no_telepon') }}" placeholder="Telepon bisnis"
                                                        {{ old('role') == 'rental' ? 'required' : '' }}>
                                                </div>
                                                @error('no_telepon')
                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="email"
                                                    ...
                                                    value="{{ old('email_perusahaan') }}" placeholder="Email bisnis">
                                            </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div id="ktpPreview" class="mt-2" style="display: none;">
                                                <img id="ktpImage" src="" alt="Preview KTP"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="file"
                                                    ...
                                                    id="foto_surat_izin_usaha" name="foto_surat_izin_usaha"
                                                    accept="image/jpeg,image/png,image/jpg"
                                                    {{ old('role') == 'rental' ? 'required' : '' }}>
                                            ...
                                            <div id="licensePreview" class="mt-2" style="display: none;">
                                                <img id="licenseImage" src="" alt="Preview Surat Izin"
                                                    class="img-thumbnail" style="max-width: 200px; max-height: 150px;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="file"
                                                    ...
                                                    id="foto_tempat" name="foto_tempat"
                                                    accept="image/jpeg,image/png,image/jpg"
                                                    {{ old('role') == 'rental' ? 'required' : '' }}>
                                            ...
                                            <div id="placePreview" class="mt-2" style="display: none;">
                                                <img id="placeImage" src="" alt="Preview Tempat Usaha"
                                                    class="img-thumbnail" style="max-width: 200px; max-height: 150px;">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label small text-muted" for="terms">
                                            Saya setuju dengan <a href="#" class="text-decoration-none">Syarat dan
                                                Ketentuan</a> dan <a href="#" class="text-decoration-none">Kebijakan
                                                Privasi</a>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="text-center">
                                    <p class="text-muted mb-0">Sudah memiliki akun?
                                        <a href="{{ route('login') }}" class="text-decoration-none fw-semibold">Masuk di
                                            sini</a>
                                    </p>
                                </div>
                            </form>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (form) {
                ...
                form.addEventListener('submit', function(e) {
                    ...
                    if (role === 'rental') {
                        const fileInputs = ['foto_ktp', 'foto_surat_izin_usaha', 'foto_tempat'];
                        let valid = true;

                        fileInputs.forEach(id => {
                            const file = document.getElementById(id).files[0];
                            if (!file) {
                                alert(`File ${id} wajib diisi`);
                                valid = false;
                            } else if (file.size > 2 * 1024 * 1024) {
                                alert(`File ${id} terlalu besar (maks 2MB)`);
                                valid = false;
                            }
                        });
